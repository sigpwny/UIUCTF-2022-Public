...
ip netns exec bridge nft add table bridge filter
ip netns exec bridge nft add chain bridge filter forward { type filter hook forward priority 0 \; policy drop \; }
ip netns exec bridge nft add rule bridge filter forward ether saddr 4a:c5:2d:9b:8c:8d ether daddr 8a:15:22:31:b4:fc accept
ip netns exec bridge nft add rule bridge filter forward ether saddr 8a:15:22:31:b4:fc ether daddr 4a:c5:2d:9b:8c:8d ip6 saddr 2001:db8:6e02:2663:8815:22ff:fe31:b4fc accept
ip netns exec bridge nft add rule bridge filter forward ether saddr 8a:15:22:31:b4:fc ip6 nexthdr ipv6-icmp accept
